...
@section('container')
    ...
    <a href="/anggota/tambah"><button class="btn btn-primary mb-2">Tambah Data</button></a>
    <form class="d-flex position-absolute end-0 top-0 me-3" role="search" method="post" action="/anggota/search">
        @csrf
    ...
    <table class="table table-hovered table-bordered">
        ...
        @foreach ($data as $dat)
            <tr>
                ...
                <td>{{ $dat->alamat }}</td>
                <td>
                    <a href="/anggota/edit?kode={{ $dat->kode }}">
                    ...
                    <a href="/anggota/hapus?kode={{ $dat->kode }}">
